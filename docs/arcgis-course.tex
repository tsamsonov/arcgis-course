...
также вводную теоретическую часть по каждой теме. В 2018 г. практикум
преобразован в интерактивный формат и выложен в открытый доступ в сеть
Интернет.
...
Географический факультет МГУ, 2018.\tabularnewline
\bottomrule
\end{longtable}
