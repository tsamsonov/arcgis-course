...
2. Дважды щелкните на названии слоя *Countries* и перейдите на вкладку __Symbology__ (Рис. \@ref(fig:mdc-sym)).
    ...
    <div class="figure">
    <img src="images/Ex03/image12.png" alt="Возможности отображения полигонального слоя" width="100%" />
...
1. Используя инструкции в разделе [Изменение проекции](#manual-projections-change) поменяйте проекцию карты на *проекцию Робинсона (Robinson)*. Ее можно найти в группе **Projected Сoordinate Systems > World**. Обратите внимание на то, как изменятся очертания объектов (Рис. \@ref(fig:mdc-proj)):
...
1. Добавьте на карту слой *Coast*, расположите его поверх слоя *Countries* и измените цвет линии на *Delft Blue* (Рис. \@ref(fig:mdc-color)):
    ...
    <div class="figure">
    <img src="images/Ex03/image19.png" alt="Изображение береговой линии" width="100%" />
...
2. Добавьте на карту слой *Lakes*, расположите его поверх слоя *Rivers* и измените его оформление следующим образом:
    ...
    *Толщина обводки*   0,5
    ...
    <div class="figure">
    <img src="images/Ex03/image20.png" alt="Изображение рек и озер" width="100%" />
    <p class="caption">(\#fig:mdc-hydro)Изображение рек и озер</p>
    </div>
...
2. Добавьте на карту слой *Cities*, расположите его поверх слоя *Lakes* и измените его параметры следующим образом (Рис. \@ref(fig:mdc-cities)):
    ...
    *Размер*     4
    ...
    <div class="figure">
    <img src="images/Ex03/image21.png" alt="Параметры отображения населенных пунктов" width="100%" />
    <p class="caption">(\#fig:mdc-cities)Параметры отображения населенных пунктов</p>
    </div>
...
1. Климатические пояса показываются на картах способом *качественного фона*. Для этого измените оформление слоя *Climates* следующим образом:
    ...
    *Показывать остальные значения* Нет
    ...
    <div class="figure">
    <img src="images/Ex03/image23.png" alt="Цвета отображения типов климата" width="100%" />
    <p class="caption">(\#fig:mdc-clim)Цвета отображения типов климата</p>
    </div>
...
1. Измените тип символа слоя на символьный маркер и задайте его параметры следующим образом (Рис. \@ref(fig:mdc-arrow)):
    ...
    *Цвет*       Серый 70%
    ...
    <div class="figure">
    <img src="images/Ex03/image24.png" alt="Значок для отображения направления течения" width="100%" />
    <p class="caption">(\#fig:mdc-arrow)Значок для отображения направления течения</p>
    </div>
...
1. Включите механизм размещения подписей __Maplex__ на панели __Labeling__ (Рис. \@ref(fig:mdc-maplex)):
    ...
    <div class="figure">
    <img src="images/Ex03/image26.png" alt="Отображение течений на карте" width="100%" />
    <p class="caption">(\#fig:mdc-maplex)Отображение течений на карте</p>
    </div>
...
2. Включите подписи для слоя *Cities* (Рис. \@ref(fig:mdc-labels)):
    ...
    <div class="figure">
    <img src="images/Ex03/image27.png" alt="Отображение течений на карте" width="100%" />
    <p class="caption">(\#fig:mdc-labels)Отображение течений на карте</p>
    </div>
...
1. Настройте параметры подписей следующим образом (Рис. \@ref(fig:mdc-labparams)):
    ...
    *Разрешение конфликтов* Never remove (никогда не удалять)
    ...
    <div class="figure">
    <img src="images/Ex03/image28.png" alt="Отображение течений на карте" width="100%" />
    <p class="caption">(\#fig:mdc-labparams)Отображение течений на карте</p>
    </div>
...
4. Установите масштаб равным `1:90 000 000` и отцентрируйте карту в пределах листа.
    ...
    <div class="figure">
    <img src="images/Ex03/image30.png" alt="Результирующий охват карты" width="100%" />
    <p class="caption">(\#fig:mdc-scale)Результирующий охват карты</p>
    </div>
...
1. Добавьте на карту легенду с помощью команды **Insert > Legend**, включив в нее только слои *Климат* и *Течения* (Рис. \@ref(fig:mdc-legendial)):
    ...
    <div class="figure">
    <img src="images/Ex03/image31.png" alt="Добавление слоев _Климат_ и _Течения_ в состав легенды" width="100%" />
...
1. В следующем диалоге название легенды оставьте пустым (Рис. \@ref(fig:mdc-legendempty)):
    ...
    <div class="figure">
    <img src="images/Ex03/image32.png" alt="Пустой заголовок легенды" width="100%" />
...
2. Уберите заголовок поля для слоя *Климат*, выделив его мышью, нажав <kbd>F2</kbd> и стерев содержимое (Рис. \@ref(fig:mdc-fieldempty)):
    ...
    <div class="figure">
    <img src="images/Ex03/image33.png" alt="Удаление заголовка поля для слоя _Климат_" width="100%" />
    <p class="caption">(\#fig:mdc-fieldempty1)Удаление заголовка поля для слоя _Климат_</p>
    </div><div class="figure">
    <img src="images/Ex03/image34.png" alt="Удаление заголовка поля для слоя _Климат_" width="100%" />
    <p class="caption">(\#fig:mdc-fieldempty2)Удаление заголовка поля для слоя _Климат_</p>
    </div>
...
2. Отключите [отображение нулевых минут и секунд](#manual-projections-zero-degrees).
