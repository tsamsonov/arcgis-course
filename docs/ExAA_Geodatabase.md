...
## Создание базы геоданных {#manual-gdb-create}

В контекстном меню папки в окне каталога выберите команду **New > File Geodatabase**:

![](images/Appendix/image75.png)

## Создание классов пространственных объектов {#manual-gdb-create-class}
...
## Установка базы геоданных по умолчанию {#manual-gdb-default}
