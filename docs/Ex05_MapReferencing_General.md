...
1. Выберите его в списке на панели **Georeferencing**:
    ...
    <div class="figure">
    <img src="images/Ex05/image12.png" alt="Выбор слоя для привязки" width="100%" />
...
<div class="figure">
<img src="images/Ex05/image14.png" alt="Созданные слои в таблице содержания карты" width="100%" />
...
1. Щелкните на шаблоне объекта *Regions* в окне **Create Features** и выберите режим создания объектов **Polygon**:
    ...
    <div class="figure">
    <img src="images/Ex05/image16.png" alt="Выбор режима создания объектов" width="100%" />
