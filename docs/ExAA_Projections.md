...
## Изменение проекции (системы координат карты) {#manual-projections-change}
...
## Вставка координатной сетки {#manual-projections-graticule}
...
## Отображение нулевых минут и секунд {#manual-projections-zero-degrees}
