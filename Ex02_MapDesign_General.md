...
3. Раскройте базу данных *MapData.gdb* и изучите ее содержимое:
    ...
    ![База данных `MapData.gdb`](images/Ex02/image10.png)
...
1. Установите передискретизацию слоя в режим кубической cвертки (*Cubic Convolution*). Результат:

    ![Гиспсометрическая окраска рельефа](images/Ex02/image12.png)
...
1. Наложите отмывку поверх гипсометрической окраски. Для этого добавьте на карту слой отмывки *Hillshade* и установите для него следующие параметры:
    ...
    *Результат*:
    ...
    ![Гиспосметрическая окраска и отмывка](images/Ex02/image13.png)
...
![Образец оформления карты](images/Ex02/image14.png)
...
![Оформление векторных слоев](images/Ex02/image15.png)
...
![Картографическое изображение с подписями](images/Ex02/image20.png)
...
3. Настройте размер кружка таким образом, чтобы его диаметр менялся от 3 до 7 пунктов
    ...
    *Результат:*
    ...
    ![Настрояка шкалы размеров значков](images/Ex02/image21.png)
...
3. Настройте подписи следующим образом:
    ...
    *Результат*:
    ...
    ![Карта с классифицированными по размеру населенными пунктами](images/Ex02/image22.png)
...
![Маскированное картографическое изображение](images/Ex02/image24.png)
...
4. Установите масштаб равным 1:1 750 000
    ...
    *Результат:*
    ...
    ![Размещение карты в пределах листа](images/Ex02/image25.png)

1. Используя настройки по умолчанию, вставьте легенду, включив в нее все слои, кроме *Elevation*, *Countries* и *Hillshade*

    *Результат:*
    
    ![Размещение легенды в пределах листа](images/Ex02/image26.png)
...
5. Увеличьте интервал между слоями в легенде до 10 пунктов.
    ...
    *Результат:*
    ...
    ![Регулировка интервала между элементами легенды](images/Ex02/image27.png)
...
1. Вставьте *километровую* масштабную линейку по нижеприведенному образцу:

    ![Карта с градусной сеткой, названием и масштабной линейкой](images/Ex02/image28.png)
