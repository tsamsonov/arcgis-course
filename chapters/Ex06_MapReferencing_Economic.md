## Создание тематической базы геоданных административного деления города

<!-- toc orderedList:0 depthFrom:3 depthTo:3 -->

* [Введение](#введение)
* [Добавление референцных данных](#добавление-референцных-данных)
* [Привязка карты](#привязка-карты)
* [Создание слоя городских районов](#создание-слоя-городских-районов)
* [Расчет статистики по районам](#расчет-статистики-по-районам)
* [Построение картодиаграмм](#построение-картодиаграмм)
* [Настройка оформления других слоев](#настройка-оформления-других-слоев)
