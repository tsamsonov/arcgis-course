## Анализ пространственных взаимосвязей методом оверлея на основе векторных данных


<!-- toc orderedList:0 depthFrom:3 depthTo:3 -->

* [Введение](#введение)
* [Визуальный анализ векторных слоев](#визуальный-анализ-векторных-слоев)
* [Организация рабочего пространства](#организация-рабочего-пространства)
* [Оверлей слоев методом пересечения](#оверлей-слоев-методом-пересечения)
* [Слияние результатов пересечения с целью получения показателя пространственной связи](#слияние-результатов-пересечения-с-целью-получения-показателя-пространственной-связи)
* [Подсчет суммарной площади каждой комбинации подтипа почв и типа рельефа](#подсчет-суммарной-площади-каждой-комбинации-подтипа-почв-и-типа-рельефа)
* [Подсчет суммарной площади каждого подтипа почв](#подсчет-суммарной-площади-каждого-подтипа-почв)
* [Добавление нового поля для результирующих значений](#добавление-нового-поля-для-результирующих-значений)
* [Соединение таблиц по названию подтипа почв](#соединение-таблиц-по-названию-подтипа-почв)
* [Вычисление результирующих значений](#вычисление-результирующих-значений)
...
* [x] Добавить на карту слои типов почв и рельефа, оформить их
* [x] Произвести оверлей слоев
* [x] Произвести слияние данных и соединение таблиц
* [x] Подсчитать процент покрытия площадей
